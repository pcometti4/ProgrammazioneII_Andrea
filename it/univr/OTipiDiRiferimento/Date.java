...
public class Date {
	...
	public boolean equals(Object other) {
		return other instanceof Date d && day == d.day &&
				month == d.month && year == d.year;
	}

	/*public boolean equals(Object other) {
		return other instanceof Date && day == ((Date) other).day &&
				month == ((Date) other).month && year == ((Date) other).year;
	}*/
